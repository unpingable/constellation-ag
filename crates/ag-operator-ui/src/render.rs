...
.panel code{overflow-wrap:anywhere;word-break:break-word}
...
mod tests {
    ...
    #[test]
    fn objective_prerequisite_and_provenance_codes_wrap_without_truncation() {
        assert!(STYLE.contains(".panel code{overflow-wrap:anywhere;word-break:break-word}"));
    }
